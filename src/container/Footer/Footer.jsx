    ...
    <div className="app__footer-links">
      ...
      <div className="app__footer-links_contact">
        <h1 className="app__footer-headtext">Contact Us</h1>
         <p className="p__opensans">The Brandling Villa, Haddricks Mill Road, South Gosforth, Newcastle Upon Tyne,
          United Kingdom,
          NE3 1QL</p>
      ...
      <div className="app__footer-links_logo">
        ...
        <p className="p__opensans">&quot;Howay man, gan in the pub and get yersel' a pint of cheer! Wor doors are always open, like a friendly Geordie's heart.&quot;</p>
